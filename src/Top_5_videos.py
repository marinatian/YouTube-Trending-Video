...
def generate_top5_videos(app, df, date_range, selected_country='US'):
    ...
    for _, row in top_5videos.iterrows():
        video_info = dbc.Col([
            html.H6(row['title'], className='mt-2', style={'white-space': 'normal', 'font-weight': 'bold','text-align':'left'}),
